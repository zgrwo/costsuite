...
{
    /// <summary>BOM 审批工作流 — 状态机：Draft → PendingReview → Approved/Rejected → Released → Obsolete</summary>
    public interface IApprovalService
    {
        /// <summary>提交审批 Draft → PendingReview</summary>
        BomVersion SubmitForReview(long versionId, long? userId = null);
        ...
        BomVersion Release(long versionId, long? userId = null);

        /// <summary>废弃版本 Released → Obsolete</summary>
        BomVersion Obsolete(long versionId, long? userId = null);
