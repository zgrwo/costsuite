...
public class BomServiceEdgeCaseTests
{
    ...
    public void Expand_EmptyItemCode_ReturnsEmptyList()
    {
        ...
        _analysisMock.Setup(a => a.ExpandBom("", It.IsAny<DateTime?>())).Returns(new List<BomExpandedNode>());
    ...
    {
        _cacheMock.Setup(c => c.Get<List<BomExpandedNode>>(It.IsAny<string>())).Returns((List<BomExpandedNode>?)null);
        _analysisMock.Setup(a => a.ExpandBom("NONEXIST", It.IsAny<DateTime?>())).Returns(new List<BomExpandedNode>());
    ...
    public void Expand_DeepBom_ReturnsAllLevels()
    {
        ...
        _cacheMock.Setup(c => c.Get<List<BomExpandedNode>>(It.IsAny<string>())).Returns((List<BomExpandedNode>?)null);
        _analysisMock.Setup(a => a.ExpandBom("ROOT", It.IsAny<DateTime?>())).Returns(nodes);
    ...
    public void Expand_DifferentDatesProduceDifferentCacheKeys()
    {
        ...
        _analysisMock.Setup(a => a.ExpandBom("MAT-001", It.Is<DateTime?>(d => d == DateTime.Today))).Returns(nodes1);
        ...
        _cacheMock.Setup(c => c.Get<List<BomExpandedNode>>(It.Is<string>(k => k.Contains(DateTime.Today.AddDays(-1).ToString("yyyy-MM-dd")))))
            .Returns((List<BomExpandedNode>?)null);
        _analysisMock.Setup(a => a.ExpandBom("MAT-001", It.Is<DateTime?>(d => d == DateTime.Today.AddDays(-1)))).Returns(nodes2);
    ...
    public void CalculateCost_SameMaterialMultiplePositions_DoesNotOverwrite()
    {
        ...
        _cacheMock.Setup(c => c.Get<List<BomExpandedNode>>(It.IsAny<string>())).Returns((List<BomExpandedNode>?)null);
        _analysisMock.Setup(a => a.ExpandBom("ASM-001", It.IsAny<DateTime?>())).Returns(nodes);
    ...
    {
        _cacheMock.Setup(c => c.Get<List<BomExpandedNode>>(It.IsAny<string>())).Returns((List<BomExpandedNode>?)null);
        _analysisMock.Setup(a => a.ExpandBom("EMPTY", It.IsAny<DateTime?>())).Returns(new List<BomExpandedNode>());
