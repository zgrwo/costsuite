...
public class BomServiceTests
{
    ...
    public void Expand_CacheHit_ReturnsFromCache()
    {
        ...
        _analysisMock.Verify(a => a.ExpandBom(It.IsAny<string>(), It.IsAny<DateTime?>()), Times.Never);
    }
    ...
    public void Expand_CacheMiss_CallsDuckDbAndCaches()
    {
        ...
        _analysisMock.Setup(a => a.ExpandBom("MAT-001", It.IsAny<DateTime?>())).Returns(nodes);
